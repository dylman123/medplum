...
import { getDerivedSearchParameters } from '../fhir/lookups/util';
import {
...
function buildSearchColumns(tableDefinition: TableDefinition, resourceType: string): void {
  ...
  for (const searchParam of [...Object.values(resourceTypeSearchParams), ...getDerivedSearchParameters(resourceType)]) {
